...
class ItemStack(object):
    ...
    def __init__(self, itemtype, img, can_place, stackable = True, itemdata = None):
        self.itemtype = itemtype
        self.img = pygame.transform.scale(img, (img.get_width() * Game.SCALE, img.get_height() * Game.SCALE))
